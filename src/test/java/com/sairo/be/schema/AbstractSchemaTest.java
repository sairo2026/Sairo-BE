...
abstract class AbstractSchemaTest {
  ...
  protected long insertMember(Connection conn, String displayName, String email)
      throws SQLException {
  ...
  protected long insertApprovedSystemAdmin(
      Connection conn, long memberId, long officeId, String bizNo) throws SQLException {
    try (PreparedStatement ps =
        conn.prepareStatement(
            "INSERT INTO office_registration (applicant_member_id, business_registration_number, real_estate_license_number, "
                ...
                + "requested_address_detail, status, resulting_office_id, reviewed_at) "
